...
if __name__ == "__main__":
    ...
    ############ Models to try ################################################
    LOGGER_FILE = "lgbCategoricalSelector_v6_100k.log"
    ...
    COUNT_COMB_COLS = [('region', 'parent_category_name'),
    ...
    columns_to_try = [col +'_counts' for col in CAT_COLS] + \
                    ['_'.join(cols) +'_counts' for cols in COUNT_COMB_COLS]
                       
    features = BASE_FEATURES + CONT_COLS + PRICE_COMB_COLS + PRICE_MEAN_COLS
