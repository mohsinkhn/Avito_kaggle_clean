...
if __name__=="__main__":
    ...
    #########################################################
    LOGGER_FILE = "logs/nnTitle_trainerv4.log"
    MODEL_ID = "title_v4"
    MODEL_CHECK_FILENAME = "{}.check".format(MODEL_ID)
    TITLE_NAMES = ["titletokens_2",
                   "title2gramtokens_0"
                 ]
    ...
    TITLE_EMBED_KWARGS = [{"input_dim": 100000, "output_dim": 120,
                           "input_length": 8, },
                          {"input_dim": 20000, "output_dim": 32,
                           "input_length": 5, }
                          ]
    TITLE_RNN_KWARGS = [{"units": 120}, None]
    ...
    FC1_PARAMS = [0.0, 150, "prelu", False]
    FC2_PARAMS = [0.0, 128, "prelu", True]
    FC3_PARAMS = [0.0, 128, "prelu", True]

    INPUT_NAMES = TITLE_NAMES #CAT_NAMES + CONT_NAMES
    INPUT_DIMS =  TITLE_DIMS#CAT_DIMS + CONT_DIMS
    INPUT_TYPES = TITLE_TYPES#CAT_TYPES + CONT_TYPES
    HIDDEN_KWARGS = TITLE_EMBED_KWARGS#CAT_EMBED_KWARGS + CONT_DENSE_KWARGS
    INPUT_RNN_KWARGS = TITLE_RNN_KWARGS#CAT_RNN_KWARGS + CONT_RNN_KWARGS
    INPUT_POOLING = TITLE_POOLING#CAT_POOLING + CONT_POOLING
    FC_LIST = [FC1_PARAMS]
