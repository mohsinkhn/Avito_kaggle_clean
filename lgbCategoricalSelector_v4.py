...
if __name__ == "__main__":
    ...
    ############ Models to try ################################################
    LOGGER_FILE = "lgbCategoricalSelector_v4_100k.log"
    ...
    columns_to_try = ['_'.join(cols) +'_trenc_'+str(TARGET_ENC_COMB_THRESH) for cols in PRICE_COMB_COLS]
                       
    features = BASE_FEATURES + CONT_COLS
