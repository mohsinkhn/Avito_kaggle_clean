...
if __name__ == "__main__":
    LOGGER_FILE = "titleFeatureRunner.log"
    ...
    for i in range(3):
        ...
        X = load_npz("../utility/X_train_title_{}.npz".format(i))
        ...
        np.save("../utility/X_train_title_ridge_comb{}".format(i), y_preds_ridge)
        y_test_ridge = rd.fit(X, y).predict(X_test)
        np.save("../utility/X_test_title_ridge_comb{}".format(i), y_test_ridge)
        #if i == 1:
