...
if __name__=="__main__":
    ...
    #########################################################
    LOGGER_FILE = "logs/nnDesc_trainerv2.log"
    MODEL_ID = "desc_v2"
    MODEL_CHECK_FILENAME = "{}.check".format(MODEL_ID)
    DESC_NAMES = ["desctokens_1",
                   "desc2gramtokens_1"
                 ]
    ...
    DESC_EMBED_KWARGS = [{"input_dim": 200000, "output_dim": 32,
                           "input_length": 100, },
                          {"input_dim": 20000, "output_dim": 16,
                           "input_length": 20, }
                          ]
